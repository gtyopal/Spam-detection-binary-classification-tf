...
def load_data_from_disk():
    ...
    df_ham = pandas.read_table("data/ham_s.csv", sep=",",encoding='latin-1', low_memory=False)
    df_spam = pandas.read_table("data/spam_s.csv", sep=",",encoding='latin-1',low_memory=False)
